  ...
  const packages = [
    {
      Place: "Kashmir",
      Days: "3D/2N",
      Images: "/assets/Images/Package/Kashmir.png",
    },
    {
      Place: "Kerala",
      Days: "4D/3N",
      Images: "/assets/Images/Package/Kerala.png",
    },
    {
      Place: "Thailand",
      Days: "28/27N",
      Images: "/assets/Images/Package/Thailand.png",
    },
    { Place: "Goa", Days: "2D/1N", Images: "/assets/Images/Package/Goa.png" },
    {
      Place: "Europe",
      Days: "28D/27N",
      Images: "/assets/Images/Package/Europe.png",
    },
    {
      Place: "Singapore",
      Days: "28D/27N",
      Images: "/assets/Images/Package/Singapore.png",
    },
  ];
      ...
      <div className="w-full max-w-[1299px] h-auto lg:h-[635px] relative ">
        ...
        <div className="lg:absolute top-0 right-0 w-full lg:w-[calc(100%-200px)]">
          <div className="flex flex-col lg:flex-row justify-between mb-4">
            <p className="font-inter font-bold text-[30px] text-TextColor">
              Top Tour Packages
            </p>
