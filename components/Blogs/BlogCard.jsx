const BlogCard = ({ image, title, description, date }) => {
  ...
  return (
    <section
      className="w-[315px] h-[335px] border border-StrokeBlue flex flex-col overflow-hidden"
    ...
    >
      ...
      <div className="p-4">
        <h2 className="text-[16px] text-TextColor font-semibold font-inter">
          {title}
        </h2>
        <p className="text-[13px] text-TextColor font-inter opacity-[70%]">
          {description}
        </p>
      </div>
    </section>
